                ...
                <div class="row g-4 justify-content-start">
                    <?php if (empty($tasks)): ?>
                        <div class="col-12 text-center text-muted">
                            ...
                            <p class="mt-2">Bekleyen görev bulunmuyor</p>
                            <p class="text-muted mb-0">Onay bekleyen görevleriniz burada listelenecektir.</p>
                                ...
                                <div class="task-card">
                                    ...
                                    <div class="task-card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <span class="badge bg-warning text-dark">İnceleniyor</span>
                                            <small class="text-muted">
                                                <?= date('d.m.Y H:i', strtotime($task->submitted_at)) ?>
                                            </small>
                                        </div>
                                    </div>
                                </div>
